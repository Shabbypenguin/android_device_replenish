...
DEVICE_PACKAGE_OVERLAYS := vendor/$VENDOR/__DEVICE__/overlay

\$(call inherit-product, vendor/$VENDOR/__DEVICE__/__DEVICE__-vendor-blobs.mk)
EOF

(cat << EOF) | sed s/__DEVICE__/$DEVICE/g > ../../../vendor/$VENDOR/$DEVICE/BoardConfigVendor.mk
